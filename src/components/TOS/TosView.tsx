...
const ContactMeHref = React.lazy(() => import('../Privacy/ContactMeHref'));
...
export default function TosView() {
  ...
  const email = showingEmail ? (
    ...
    <button
      onClick={() => {
        // setEmailAddress(
        //   //Decrypts my email (used solely for obfuscation, a temporary solution).
        //   decrypt(
        //     'ff9a8d9694d1929e8d8b96919a8c8c9e919c979a8cbf98929e9693d19c9092',
        //   ),
        // );
  ...
  return (
    <div>
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME}, you confirm that you are in
      ...
      <p>
        Under no circumstances shall {import.meta.env.VITE_APP_APP_NAME} team be
        liable for any direct, indirect, special, incidental or consequential
        damages, including, but not limited to, loss of data or profit, arising
        out of the use, or the inability to use, the materials on this site,
        even if
        {import.meta.env.VITE_APP_APP_NAME} team or an authorized representative
      ...
      <p>
        {import.meta.env.VITE_APP_APP_NAME} will not be responsible for any
        outcome that may occur during the course of usage of our resources. We
        reserve the rights to change prices and revise the resources usage
        policy in any moment. This Terms & Conditions was created with{' '}
      ...
      <h1>License</h1>
      <p>
        {import.meta.env.VITE_APP_APP_NAME} grants you a revocable,
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME}", "us", "we" or "our"), the provider
        of the {import.meta.env.VITE_APP_APP_NAME} website and the services
        accessible from the {import.meta.env.VITE_APP_APP_NAME} website (which
        are collectively referred to in these Terms & Conditions as the "
        {import.meta.env.VITE_APP_APP_NAME} Service").
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the{' '}
        {import.meta.env.VITE_APP_APP_NAME} Service. In these Terms &
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of {import.meta.env.VITE_APP_APP_NAME} or
          its affiliates, partners, suppliers or the licensors of the website.
        </li>
      </ul>
      <h1>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at {import.meta.env.VITE_APP_APP_NAME}. We
      ...
      <p>
        ...
        apply to transactions at {import.meta.env.VITE_APP_APP_NAME}. We’ll be
        as brief as our attorneys will allow. The main thing to remember is that
        by placing an order or making a purchase at{' '}
        {import.meta.env.VITE_APP_APP_NAME}, you agree to the terms along with{' '}
        {import.meta.env.VITE_APP_APP_NAME}'s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME} with respect to the website shall
        remain the sole and exclusive property of{' '}
        {import.meta.env.VITE_APP_APP_NAME}.
      </p>
      <p>
        {import.meta.env.VITE_APP_APP_NAME} shall be free to use, copy, modify,
      ...
      <p>
        You acknowledge and agree that {import.meta.env.VITE_APP_APP_NAME} may
        stop (permanently or temporarily) providing the Service (or any features
        ...
        {import.meta.env.VITE_APP_APP_NAME} when you stop using the Service. You
        acknowledge and agree that if {import.meta.env.VITE_APP_APP_NAME}{' '}
      ...
      <p>
        {import.meta.env.VITE_APP_APP_NAME} reserves the right to modify,
      ...
      <p>
        {import.meta.env.VITE_APP_APP_NAME} may from time to time provide
      ...
      <p>
        ...
        the website. You agree that {import.meta.env.VITE_APP_APP_NAME} has no
      ...
      <p>
        {import.meta.env.VITE_APP_APP_NAME} may, in its sole discretion, at any
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME}, in the event that you fail to
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME}'s rights or remedies at law or in
      ...
      <p>
        You agree to indemnify and hold {import.meta.env.VITE_APP_APP_NAME} and
        ...
        including reasonable attorneys' fees, due to or arising out of your: (a)
      ...
      <p>
        ...
        permitted under applicable law, {import.meta.env.VITE_APP_APP_NAME}, on
        ...
        limitation to the foregoing, {import.meta.env.VITE_APP_APP_NAME}{' '}
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME} nor any{' '}
        {import.meta.env.VITE_APP_APP_NAME}'s provider makes any representation
        ...
        on behalf of {import.meta.env.VITE_APP_APP_NAME} are free of viruses,
      ...
      <p>
        ...
        of {import.meta.env.VITE_APP_APP_NAME} and any of its suppliers under
        any provision of this Agreement and your exclusive remedy for all of the
        foregoing shall be limited to the amount actually paid by you for the
        website.
      </p>
      <p>
        To the maximum extent permitted by applicable law, in no event shall{' '}
        {import.meta.env.VITE_APP_APP_NAME} or its suppliers be liable for any
        ...
        {import.meta.env.VITE_APP_APP_NAME} or any supplier has been advised of
      ...
      <p>
        ...
        notices published by {import.meta.env.VITE_APP_APP_NAME} on the
        Services, shall constitute the entire agreement between you and{' '}
        {import.meta.env.VITE_APP_APP_NAME} concerning the Services. If any
        ...
        term, and {import.meta.env.VITE_APP_APP_NAME}'s failure to assert any
        right or provision under this Agreement shall not constitute a waiver of
        such right or provision. YOU AND {import.meta.env.VITE_APP_APP_NAME}{' '}
      ...
      <p>
        {import.meta.env.VITE_APP_APP_NAME} reserves the right, at its sole
      ...
      <p>
        ...
        {import.meta.env.VITE_APP_APP_NAME} regarding your use of the website
        and supersedes all prior and contemporaneous written or oral agreements
        between you and {import.meta.env.VITE_APP_APP_NAME}.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other {import.meta.env.VITE_APP_APP_NAME}'s
        services, which {import.meta.env.VITE_APP_APP_NAME} will provide to you
      ...
      <p>
        ...
        thereof), are owned by {import.meta.env.VITE_APP_APP_NAME}, its
        ...
        {import.meta.env.VITE_APP_APP_NAME}, unless and except as is expressly
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR {import.meta.env.VITE_APP_APP_NAME}'s
        INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
        action, or other controversy between you and{' '}
        {import.meta.env.VITE_APP_APP_NAME} concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or {import.meta.env.VITE_APP_APP_NAME}{' '}
        ...
        requested. You must send any Notice of Dispute via email to the email
        appearing below this paragraph  . {import.meta.env.VITE_APP_APP_NAME}{' '}
        will send any Notice of Dispute to you by mail to your address if we
        have it, or otherwise to your email address. You and{' '}
        {import.meta.env.VITE_APP_APP_NAME} will attempt to resolve any dispute
        through informal negotiation within sixty (60) days from the date the
        Notice of Dispute is sent. After sixty (60) days, you or{' '}
        {import.meta.env.VITE_APP_APP_NAME} may commence arbitration.
      </p>
      ...
      <p>
        If you and {import.meta.env.VITE_APP_APP_NAME} don’t resolve any dispute
        by informal negotiation, any other effort to resolve the dispute will be
      ...
      <p>
        ...
        and will become the sole property of {import.meta.env.VITE_APP_APP_NAME}{' '}
        without any compensation or credit to you whatsoever.{' '}
        {import.meta.env.VITE_APP_APP_NAME} and its affiliates shall have no
      ...
      <h1>Promotions</h1>
      <p>
        {import.meta.env.VITE_APP_APP_NAME} may, from time to time, include
        contests, promotions, sweepstakes, or other activities (“Promotions”)
      ...
      <p>
        ...
        of {import.meta.env.VITE_APP_APP_NAME}.{' '}
        {import.meta.env.VITE_APP_APP_NAME} will be entitled to injunctive or
        ...
        {import.meta.env.VITE_APP_APP_NAME} operates and controls the{' '}
        {import.meta.env.VITE_APP_APP_NAME} Service from its offices in Sweden.
        ...
        choose to access the {import.meta.env.VITE_APP_APP_NAME} Service from
        ...
        {import.meta.env.VITE_APP_APP_NAME} Privacy Policy) contains the entire
        understanding, and supersedes all prior understandings, between you and{' '}
        {import.meta.env.VITE_APP_APP_NAME} concerning its subject matter, and
      ...
      <h1>Disclaimer</h1>
      <p>
        {import.meta.env.VITE_APP_APP_NAME} is not responsible for any content,
        code or any other imprecision.
      </p>
      <p>
        {import.meta.env.VITE_APP_APP_NAME} does not provide warranties or
        guarantees.
      </p>
      <p>
        In no event shall {import.meta.env.VITE_APP_APP_NAME} be liable for any
      ...
      <p>
        The {import.meta.env.VITE_APP_APP_NAME} Service and its contents are
        provided "as is" and "as available" without any warranty or
        representations of any kind, whether express or implied.{' '}
        {import.meta.env.VITE_APP_APP_NAME} is a distributor and not a publisher
        of the content supplied by third parties; as such,{' '}
        {import.meta.env.VITE_APP_APP_NAME} exercises no editorial control over
        ...
        {import.meta.env.VITE_APP_APP_NAME} Service. Without limiting the
        foregoing, {import.meta.env.VITE_APP_APP_NAME} specifically disclaims
        all warranties and representations in any content transmitted on or in
        connection with the
        {import.meta.env.VITE_APP_APP_NAME} Service or on sites that may appear
        as links on the {import.meta.env.VITE_APP_APP_NAME} Service, or in the
        products provided as a part of, or otherwise in connection with, the{' '}
        {import.meta.env.VITE_APP_APP_NAME} Service, including without
        limitation any warranties of merchantability, fitness for a particular
        purpose or non-infringement of third party rights. No oral advice or
        written information given by {import.meta.env.VITE_APP_APP_NAME} or any
        ...
        change without notice. Without limiting the foregoing,{' '}
        {import.meta.env.VITE_APP_APP_NAME} does not warrant that the{' '}
        {import.meta.env.VITE_APP_APP_NAME} Service will be uninterrupted,
